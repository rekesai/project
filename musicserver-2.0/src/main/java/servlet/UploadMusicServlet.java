...
//            part.write(SAVEPATH+fileName);
            ...
            if ("".equals(fileName)) {
                ...
                PrintWriter out = resp.getWriter();
                out.println("<script type='text/javascript'>alert('请选择音乐文件！');location='upload.html';</script>");
            }
            else {
                part.write(SAVEPATH+fileName);
                ...
                if ("".equals(singer)) {
                    ...
                    PrintWriter out = resp.getWriter();
                    out.println("<script type='text/javascript'>alert('请输入歌手名！');location='upload.html';</script>");
                }
                else {
                    // 获取歌曲名
